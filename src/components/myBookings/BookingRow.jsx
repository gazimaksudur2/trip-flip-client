...
const BookingRow = ({ booking, reviewModal, handleReviewInfo }) => {
    ...
    // const updateModal = (
    //     <>
    //         <dialog id="my_modal_1" className="modal backdrop-blur-sm rounded-xl">
    //                 <UpdateBooking/>
    //         </dialog>
    //     </>
    // )
        ...
        <>
            ...
            <td className="px-4 py-4 text-sm whitespace-nowrap">
                <div className="flex items-center justify-center gap-x-6">
                    ...
                    <button className="text-gray-500 transition-colors duration-200 -300 hover:text-yellow-500 focus:outline-none" onClick={() => document.getElementById('my_modal_1').showModal()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
