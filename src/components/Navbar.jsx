...
const Navbar = () => {
    ...
    // console.log(user);
    const avatar = (<div htmlFor="my-drawer-4" className="drawer-button avatar">
    ...
    const navLinks = (<>
        ...
        {user && <NavLink to={'/bookings'} className={({ isActive }) => isActive ? 'block h-10 px-5 py-2 mt-4 text-sm text-center text-gray-700 capitalize transition-colors duration-300 transform border rounded-md dark:hover:bg-gray-700 dark:text-white lg:mt-0 hover:bg-gray-100 lg:w-auto' : 'text-gray-700 lg:mx-6 dark:text-gray-200 dark:hover:text-blue-400 hover:text-blue-500'}>My Bookings</NavLink>}
        ...
        <div>
            <section className="bg-gray-900">
                <nav className="w-full px-10 py-6 mx-auto lg:flex lg:justify-between lg:items-center">
                    ...
                    <div className="absolute inset-x-0 z-20 w-[80%] flex justify-between items-center px-6 py-4 transition-all duration-300 ease-in-out bg-blue-300 shadow-md lg:bg-transparent lg:shadow-none lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
                        ...
                        <div className="drawer drawer-end">
                            ...
                            <div className="drawer-content flex justify-center items-center">
                                {user ? avatar : logs}
                                <label htmlFor="my-drawer-4" className="drawer-button btn btn-primary">Op</label>
                            </div>
