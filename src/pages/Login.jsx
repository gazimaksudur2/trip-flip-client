                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-between mt-4">
                                <div className="form-control">
                                    <label className="label cursor-pointer flex flex-row-reverse gap-4">
                                        <span className="label-text text-gray-200 font-jakarta placeholder-gray-400 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-500">Remember me</span>
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-200 hover:underline">Forget Password?</p>
                            </div>
                            ...
                            <div className="space-y-3 flex flex-col justify-center items-center">
                                ...
                                <Link to={'/authenticate/register'}>
                                    <p className="text-sm py-2 text-gray-200 font-jakarta placeholder-gray-400 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-500">{reg_here}<button onClick={() => tractPrivate('/authenticate/register')} className="hover:text-blue-600 hover:underline hover:cursor-pointer">Register here</button></p>
                                </Link>
                            </div>
                        </form>
                    </div>
